...
namespace StepDX
{
    public class Background
    {
        ...
        public Background(Device device, float width, float height,float start)
        {
            this.device = device;
            ...
            stm.Write(new CustomVertex.PositionColoredTextured(start, 0, 0, clr, 0, 1));
            stm.Write(new CustomVertex.PositionColoredTextured(start, height, 0, clr, 0, 0));
